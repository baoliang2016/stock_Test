...
class TrendIndicatorA:
    def __init__(self, stock_code="sh.000980", start_date="2023-06-01", end_date="2025-02-28", ma_period=15, trend_threshold=10, require_qqe_red_on_sell=True):
    ...
    def _login_baostock(self):
        lg = bs.login()
        logging.info(f"Baostock login response - code: {lg.error_code}, msg: {lg.error_msg}")
        if lg.error_code != '0':
...
def get_all_stocks(date="2025-02-28"):
    """获取指定日期的所有A股股票代码"""
...
def screen_stocks_for_buy_signals(start_date="2025-02-01", end_date="2025-02-28", days=3):
